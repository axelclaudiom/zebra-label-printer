...
def generate_zpl(item: dict, price=None) -> str:
    ...
    zpl = (
        ...
        '^FO22,160^A0N,20,20^FH^FDTarjeta:^FS\n'
        '^FO22,202^A0N,30,30^FH^FD${price_text}^FS\n'
        '^FO220,160^A0N,20,20^FH^FDEfectivo:^FS\n'
        '^FO220,202^A0N,30,30^FH^FD${discount_text}^FS\n'
        '^CI28\n'
        '^XZ'
